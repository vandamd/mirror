// HTTPServer.swift — Minimal HTTP server for the Chrome fallback viewer.
//
// Serves a single HTML page that connects to the WebSocket server and renders
// JPEG frames on a canvas. Used when the native Android TCP client isn't available.
