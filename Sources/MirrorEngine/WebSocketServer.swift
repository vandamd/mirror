// WebSocketServer.swift — WebSocket fallback server for Chrome-based viewers.
//
// Sends JPEG frames over WebSocket for the HTML viewer fallback path.
// Used when the native TCP client isn't available (e.g. viewing from a browser).
